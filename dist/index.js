...
const MultiplayerExtension_1 = __importDefault(require("./plugins/MultiplayerExtension"));
...
class RichMarkdownEditor extends React.PureComponent {
    constructor() {
        ...
        this.getImages = () => {
            ...
            this.view.state.doc.forEach(node => {
                var _a;
                if (node.type.name === "paragraph" && node.childCount == 1 && ((_a = node.firstChild) === null || _a === void 0 ? void 0 : _a.type.name) == "image") {
